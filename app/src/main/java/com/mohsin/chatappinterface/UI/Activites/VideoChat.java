...
import com.mohsin.chatappinterface.Helpers.Entities.PermissionChecker;
import com.mohsin.webrtc_client.PeerConnectionParameters;
import com.mohsin.webrtc_client.WebRtcClient;
...
public class VideoChat extends AppCompatActivity implements WebRtcClient.RtcListener{
    ...
    private void checkPermissions() {
        permissionChecker.verifyPermissions(this, RequiredPermissions, new PermissionChecker.VerifyPermissionsCallback() {
            ...
            public void onPermissionDeny(String[] permissions) {
                Toast.makeText(VideoChat.this, "Please grant required permissions.", Toast.LENGTH_LONG).show();
            }
        });
    }
